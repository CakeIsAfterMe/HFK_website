...
{{< lead >}}
Списки, кортежи, множества, словари и всё, что с ними связано. Первая часть серии конспектов по языку Python.
{{< /lead >}}

## **Вещи, которые я бы хотел запомнить**
